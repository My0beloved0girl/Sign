...
layui.extend({
    ...
    var tableIns = table.render({
        elem: '#newsList',
        url : '/MenuTest/UserServletInterface?action=allUserByName',
        toolbar: '#toolbarDemo',
        page : true,
        height: 'full-145',
        limit : 10,
        ...
        cols : [[
            ...
            {field: 'uname', title: '登录名', minWidth:100, align:"center"},
            ...
            {field: 'isStatus', title: '状态', align:'center',templet:function(d){
