      ...
      <li class="layui-nav-item">
        ...
        <a href="javascript:;">
         ...
         <c:forEach items="${list2}" var="li">
         	${li.userName}
         	<input type="hidden" class="loginName" value="${li.loginName}"/>
			<input type="hidden" class="clas" value="${li.clas}"/>
         	<input type="hidden" class="role" value="${li.role}"/>										
        </c:forEach>
        </a>
