...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
 ...
 <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="sfz" id="sfz" lay-verify="required" placeholder="请输入身份证" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="banji" id="banji" lay-verify="required" placeholder="请输入班级" autocomplete="off" class="layui-input">
    </div>
  </div>
...
<script type="text/javascript" src="../js/uapjs/uapyh.js"></script>
</body>
</html>